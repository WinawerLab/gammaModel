function [results,modelfit] = helpfit_NBF(stimulus,params,ecog_vals,seeds)
%
...
%%%% NBF model
modelfun = @(pp,dd) pp(4) * std(reshape(reshape(dd,[],res*res) * gaufun1(pp),[],8),[],2) .^ pp(5);
